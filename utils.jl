...
function postprocess_it(filename, out_path, fig_path)
    # post-process a markdown file generated by Weave or Literate for
    # compatibility with Franklin by replacing ![...](...) with \figalt or \fig,
    # moving any generated image, and properly handling the title
